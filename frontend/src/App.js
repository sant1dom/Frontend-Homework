...
function App() {
    ...
    return (
        <>
            <BrowserRouter>
                <div className="App backdrop-filter backdrop-blur-lg" style={{minHeight: "91vh"}}>
                    <Routes>
            ...
            <footer
                className="bg-opacity-50 backdrop-blur-lg relative bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
